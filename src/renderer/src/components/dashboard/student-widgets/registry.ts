...
export const STUDENT_WIDGETS: WidgetDef[] = [
  ...
  // ── Widgets optionnels ──
  { id: 'live',          label: 'Live',               icon: Zap,            description: 'Session interactive en cours',              category: 'essential',      sizes: ['2x1', '4x1'],                defaultSize: '2x1', defaultEnabled: false, role: 'student' },
