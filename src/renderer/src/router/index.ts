...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/exam/:travailId(\\d+)',        component: () => import('@/views/ExamSessionView.vue'), name: 'exam-session' },
    { path: '/exam-review/:travailId(\\d+)', component: () => import('@/views/ExamReviewView.vue'),  name: 'exam-review', meta: { requiredRole: 'teacher' } },
